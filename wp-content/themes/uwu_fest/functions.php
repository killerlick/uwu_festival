<?php
/**
 * uwu_fest functions and definitions
 *
 ...
 */
function uwu_fest_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on uwu_fest, use a find and replace
		* to change 'uwu_fest' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'uwu_fest', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'uwu_fest_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'uwu_fest_setup' );
 ...
 */
function uwu_fest_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'uwu_fest_content_width', 640 );
}
add_action( 'after_setup_theme', 'uwu_fest_content_width', 0 );
 ...
 */
function uwu_fest_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'uwu_fest' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'uwu_fest' ),
...
add_action( 'wp_enqueue_scripts', 'uwu_fest_scripts' );
